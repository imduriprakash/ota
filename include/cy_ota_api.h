...
#define CY_RSLT_MODULE_OTA_SERVER_DROPPED_CNCT  (CY_RSLT_MODULE_OTA_BASE +  9) /**< Broker/Server disconnect */
...
typedef struct cy_ota_http_params_s {
    ...
    const char              *data_file;                 /**< filename for OTA Image     */
...
typedef struct cy_ota_network_params_s {
    ...
    /* Common parameters */
    cy_ota_server_info_t        server;                 /**< Server/MQTT Broker                         */
